...
* Традиционно Whitepaper это документ, который описывает техническое решение какой-то проблемы, и формат этого документа зависит от целевой аудитории. Если это топ менеджеры, то Whitepaper фокусируется более на финансовых и бизнес выгодах решения, а если читатели технари, то Whitepaper больше внимания уделяет техническим деталям. 
* Особенность **Whitepaper для ICO** в том, что ее основная целевая группа, это **крипто инвесторы**, которые могут представлять фонды, а могут быть и частными лицами, но все они читают Whitepaper с единтвенной целью - принять решение купить токены проекта или нет.  **И чтение Whitepaper - для них необходимое зло и трата времени.**
* Таким образом, основная функция Whitepaper - подвести потенциального крипто инвестора к **решению о покупке токена, предоставив соответствующие аргументы**. Сама аргументация в этом смысле достаточно стандартна, и может совпадать с концепцией бизнес плана. При этом подразумевается, что инвесторов/ покупателей токенов интересую примерно типовые вопросы, на которые он ожидает получить убедительные ответы. 
* Whitepaper в каким-то смысле организует разговор с инвестором, когда у него возникают в голове определенные возражения, а задача Whitepaper снимать их, постепенно переводя читателя из состояния сомнения в состояние алчного вожделения.
* Whitepaper должна нажать на определенные кнопки в сознании, запустить позитивные триггеры, а с другой стороны не породить сомнения. **Whitepaper - чисто манипулятивный документ.**

Whitepaper всегда должна предоставлять аргументы, логичные обоснования и факты. Акцент зависит от того, для кого предназначена бумага и какие факторы аудитория принимает в расчет:

* Инвесторы, бизнесмены, предприниматели больше обращают внимание на рынок и перспективы, уделяя меньше внимания решению и продукту, которого может еще и не быть. **Собирать деньги на реализацию того, что еще нет - нормально.**
* Технари больше обращают внимания на описание технических подходов к решению, продукт.
* И все категории читателей принимают во внимание риск, информацию о команде, экспертизе, токенах, юридические вопросы.

Все эти моменты отражены в примерной структуре и стиле ICO.

### Структура Whitepaper

Здесь датся более развернутое содержание, оно может быть больше или меньше в зависимости от акцента.

#### 1. Бизнес часть.

1. Проблема, с которой сталкиваются потенциальные потребители - которую Вы собираетесь решать.
...
- Описание должено в целом давть представление о том как вы будете преодолевать специфические проблемы.
- В чем инновация?
- Какие роли, кейсы, как это будет работать?
- Как это будет внедряться, как масштабироваться?
- Возможно операционный цикл.
5. Описание продукта, если оно есть или хотя бы представление о нем. Продукт не есть решение. Решение это способ помочь клиенту получить то, чего он хочет удобным способом, а продукт это способ заработать на этом деньги. Продукт включает решение и модели монетизации, так как часто они сильно связаны. Вы должны объяснить покупателям токена - как вы будете зарабатывать деньги или обеспечивать жизнеспособность проекта?
...
8. Team — руководство, ключевые сотрудники и их опыт.
9. Маркетинг - как вы собираетесь масштабировать свое решение и как привлекать клиентов.
10. Financial Projections — на что будут расходоваться инвестиции и как возникать доход.

#### 2. Экономика токена

1. Функция токена, виды, как работает - это критически важно, потому что экспертиза данного раздела может быть основанием для отнесения вашего токена к категории securities. ( В чем нет ничего плохого, если вы готовы принять последствия).
...
5. Условия продажи токена и связанные с этим ограничения. Здесь идет ссылка на отдельный документ - Terms, который является публичной офертой. Т.е. White paper - это описательный документ, он не имеет серьезной юридической силы, кроме ваших обещаний. А вот Terms конкретно описывает условия продажи токенов, какие обязательства и права возникают у проекта и токенхолдеров. Информация в White paper должна коррелировать с содержанием Terms.
6. Какой тип токена вы используете, на какой платформе?
7. Обращение токена, листинг.

#### 3. Смарт контракт - если вы его применяете.

1. Юридические аспекты токена, его продажи и обращения. Смысл и содержание ваших Terms на понятном и человеческом языке.
2. Вы описываете логику смарт-контакта.
3. Ссылка на код смарт-контракта на Github.
4. Информация об аудите смарт-контакта.


### Базовые принципы/ рекомендации при написании WP


1. Определите целевую аудиторию вашего сейла - это долгосрочные интересанты (если речь идет об инвестициях), потенциальные пользователи продукта, спекулянты. У этих аудиторий разные интересы и потребности, они предъявляют разные требования к проектам.

* Если Вы ищите долгосрочных токенхолдеров, которые готовы быть с вашим проектом долго ради его перспективы, то вы делаете акцент на бизнес аспект, потому, что вам надо доказать рыночные перспективы, наличие решения и вашу способность реализовать амбиции.
* Если ваша аудитория - потенциальные клиенты, то вы делаете упор на использование токена в будущем проекте и какие выгоды они получат от пребывания в вашем коммунити, также вы акцентируете выгоды, которые они получат, приобретая ваши токены.
* Если ваша аудитория - спекулянты, то вам надо делать акцент на стратегию обращения и понимание когда и как токены выйдут на биржу, как можно их продавать, какие предпосылки роста стоимости токенов.
* Если ваши интересанты классического типа, предприниматели, маркетологи, то вы используете более маркетинговый стиль.
* Если ваши интересанты техногики и разработчики, то вы используете больше технический стиль.
* Если вы привлекаете интересантов из разных стран, то давайте релевантную рыночную информацию, связанную с глобальным рынком, где вы будете работать и с национальным рынком, где живет данная группа. Версии White Paper для разных языковых доменов могут отличаться.

2. Пишите проще как можете, особенно когда говорите о технологияхъ и решениях. Признак профессионала - способность объяснить сложные вещи без дополнительной сущности. **Пишите как для идиотов!** Не надо писать как Виталик Бутерин. Вы не Виталик Бутеринг, а когда им станете, то будете легко писать пургу. Но пока вы не он - пишите то, что имеет смысл.

3. Баланс инфографики и текста. Используйте только содержательную графику, которая реально помогает понять суть.

4. Учитывайте, что люди **НЕ БУДУТ** читать ваш текст, а будут его **быстро просматривать**, поэтому сформулируйте ключевые тезисы так, чтобы можно было прочитать только заголовки выделенные крупным шрифтом. Проведите тест - уберите весь текст, оставьте только заголовки и вводные фразы. Смысл должен сохраниться. Если он уходит - значит надо работать.

5. White Paper - как сценарий - не пишут, а переписывают. Идите короткими итерациями. Написали - дайте прочитать референтной группе, исправьте, снова. Первая цель White Paper - чтобы было совершенно понятно о чем речь.


### Как писать Whitepaper? Последовательность и процесс.

1. Сначала напишите про что бизнес - проблема, клиент, как вы реашаете проблему, как хотите на этом заработать и зачем вам блокчейн и токен, а также что вы хотите от людей и что предлагаете взамен. **Это надо изложить на 1 странице.** Дать почитать разным людям, собрать ответы и убедиться, что все понятно, протестировать привлекательно или нет, собрать вопросы. Идеальный результат - незнакомые люди должны захотеть купить токен "если это правда" **НЕ ЧИТАЯ White Paper**. Работайте с одностраничной White Paper пока не достигнете результат, собирайте вопросы и возражения.
2. Начните разворачивать разделы, опираясь не на то, что вы хотите сказать, а на то, что люди хотят услышать и понять. Дать почитать разным людям, собрать ответы и убедиться, что все понятно, протестировать привлекательно или нет, собрать вопросы. Идеальный результат - незнакомые люди должны захотеть купить токен. Работайте с White Paper пока не достигнете результат, собирайте вопросы и возражения.
3. Когда вроде все работает, добавьте графику, верстку. Текст должен работать без графики, но графика и элементы дизайна могут усилить.
4. Помните - ваш White Paper = длинный лендинг + Call For Action!
