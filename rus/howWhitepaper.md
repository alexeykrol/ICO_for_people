...
* Особенность Whitepaper для ICO в том, что ее основная целевая группа, это крипто инвесторами, которые могут представлять фонды, а могут быть и частными лицами, но все они читают Whitepaper с единтвенной целью - принять решение купить токены проекта или нет. 
...
* Whitepaper должна нажать на определенные кнопки, запустить позитивные триггеры, а с другой стороны не породить сомнения. 
...
* Технари больше обращают внимания на описание подходов к решению, продукт.
* И все категории читателей принимают во внимание информацию о команде, экспертизе, токенах, юридических вопросах.

Все эти моменты отражены в примерной структуре и стиле ICO.

### Структура Whitepaper

Здесь датся более развернутое содержание, но может быть больше или меньше в зависимости от акцента.
...
10. Financial Projections — на что будут расходоваться инвестиции и как получатся доход.
...
* Если ваша аудитория - потенциальные клиенты, то вы делаете упор на использоавние токена в будущем проекте и какие выгоды они получат от пребывния в вашем коммунити, также вы акцентируете выгоды, которые они получат, приобретая ваши токены.
* Если ваша аудитория - спекулянты, то вам надо делать акцент на стратегию обращения и понимание когла и как токены выйдут на биржу, как можно их продавать, какие предпосылки роста стоимости токенов.
...
2. Пишите проще как можете, особенно когда говорите о технологияхъ и решениях. Признако профессионала - способность объяснить сложные вещи без дополнительной сущности.

3. Баланс инфографики и текста. Используйте только содержательную графику, которая реально помогает понять суть.

4. Учитывайте, что люди НЕ БУДУТ читать ваш текст, а будут его быстро просматривать, поэтому сформулируйте ключевые тезисы так, чтобы можно было прочитать только заголовки выделения крупным шрифтом. Проведите тест - уберите весь текст, оставьте только заголовки и вводные фразы. Смысл должен сохраниться. Если он уходит - значит надо работать.

5. White Paper - как сценарий - не пишут, а переписывают. Идите короткими итерациями. Написали - дайте прочитать референтной группе, исправьте, снова. 1 цель White Paper - чтобы было совершенно понятно о чем речь.
